...
# Python class: ScoringRequestOutput

defmodule Vllm.Outputs.ScoringRequestOutput do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "ScoringRequestOutput"
  ...
  @doc """
  Python method `ScoringRequestOutput.from_base`.
