...
# Python class: ExplicitEncoderDecoderPrompt

defmodule Vllm.Inputs.ExplicitEncoderDecoderPrompt do
  @moduledoc """
  ...
  def __snakebridge_python_class__, do: "ExplicitEncoderDecoderPrompt"
