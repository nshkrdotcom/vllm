...
defmodule Vllm do
  ...
  def __functions__ do
    [
      ...
      {:vllm_rocm_custom_paged_attn, 0, __MODULE__, ""},
      {:vllm_tool_parse_regex_timeout_seconds, 0, __MODULE__, ""},
      {:vllm_rocm_fp8_mfma_page_attn, 0, __MODULE__, ""},
      ...
      {:vllm_audio_fetch_timeout, 0, __MODULE__, ""},
      {:vllm_image_fetch_timeout, 0, __MODULE__, ""},
      {:vllm_dp_rank, 0, __MODULE__, ""},
      {:default_logging_config, 0, __MODULE__, ""},
      ...
      {:prompt_logprobs, 0, __MODULE__, ""},
      {:memory_plan_reuse_patched, 1, __MODULE__, ""},
      {:trace_headers, 0, __MODULE__, ""},
      ...
      {:logger, 0, __MODULE__, ""},
      {:vllm_use_ray_compiled_dag_channel_type, 0, __MODULE__, ""},
      {:str_dtype_to_torch_dtype, 1, __MODULE__, ""},
      {:__dir__, 0, __MODULE__, ""},
      {:vllm_use_flashinfer_moe_fp16, 0, __MODULE__, ""},
      ...
      {:env_info_fmt, 0, __MODULE__, ""},
      {:vllm_rocm_sleep_mem_chunk_size, 0, __MODULE__, ""},
      {:vllm_moriio_connector_read_mode, 0, __MODULE__, ""},
      {:vllm_skip_p2_p_check, 0, __MODULE__, ""},
      {:pretty_str, 1, __MODULE__, ""},
      {:verbose, 0, __MODULE__, ""},
      {:vllm_gpt_oss_harmony_system_instructions, 0, __MODULE__, ""},
      {:get_cuda_module_loading_config, 0, __MODULE__, ""},
      {:vllm_deepep_high_throughput_force_intra_node, 0, __MODULE__, ""},
      {:singleton_prompt, 0, __MODULE__, ""},
      {:vllm_config_root, 0, __MODULE__, ""},
      {:__getattr__, 1, __MODULE__, "Gets environment variables lazily."},
      {:vllm_v1_use_outlines_cache, 0, __MODULE__, ""},
      {:vllm_debug_workspace, 0, __MODULE__, ""},
      {:get_decode_context_model_parallel_world_size, 0, __MODULE__,
       "Return world size for the decode context model parallel group."},
      {:plugins_loaded, 0, __MODULE__, ""},
      ...
      {:vllm_rocm_use_aiter_unified_attention, 0, __MODULE__, ""},
      {:vllm_tuned_config_folder, 0, __MODULE__, ""},
      {:vllm_sleep_when_idle, 0, __MODULE__, ""},
      {:vllm_use_v2_model_runner, 0, __MODULE__, ""},
      ...
      {:vllm_force_aot_load, 0, __MODULE__, ""},
      {:vllm_flashinfer_workspace_buffer_size, 0, __MODULE__, ""},
      ...
      {:vllm_debug_log_api_server_response, 0, __MODULE__, ""},
      {:_get_child_signature, 1, __MODULE__,
       "Get a signature for a child module to detect duplicates."},
      {:_current_platform, 0, __MODULE__, ""},
      {:vllm_nixl_abort_request_timeout, 0, __MODULE__, ""},
      {:stat_logger_plugins_group, 0, __MODULE__, ""},
      {:vllm_moriio_post_batch_size, 0, __MODULE__, ""},
      {:vllm_lora_resolver_cache_dir, 0, __MODULE__, ""},
      {:load_general_plugins, 0, __MODULE__,
       "WARNING: plugins can be loaded for multiple times in different"},
      {:vllm_ringbuffer_warning_interval, 0, __MODULE__, ""},
      ...
      {:default_pip_patterns, 0, __MODULE__, ""},
      {:supported_task, 0, __MODULE__, ""},
      {:default_conda_patterns, 0, __MODULE__, ""},
      {:vllm_docker_build_context, 0, __MODULE__, ""},
      {:logger, 0, __MODULE__, ""},
      {:tpu_platform_plugin, 0, __MODULE__, ""},
      {:vllm_execute_model_timeout_seconds, 0, __MODULE__, ""},
      {:batchsize_logging_interval, 0, __MODULE__, ""},
      {:vllm_use_ray_compiled_dag_overlap_comm, 0, __MODULE__, ""},
      {:cuda_visible_devices, 0, __MODULE__, ""},
      {:vllm_use_modelscope, 0, __MODULE__, ""},
      {:vllm_enable_cudagraph_gc, 0, __MODULE__, ""},
      ...
      {:vllm_allow_chunked_local_attn_with_hybrid_kv_cache, 0, __MODULE__, ""},
      ...
      {:vllm_blockscale_fp8_gemm_flashinfer, 0, __MODULE__, ""},
      ...
      {:vllm_fused_moe_chunk_size, 0, __MODULE__, ""},
      {:vllm_use_experimental_parser_context, 0, __MODULE__, ""},
      {:s3_endpoint_url, 0, __MODULE__, ""},
      {:vllm_tpu_using_pathways, 0, __MODULE__, ""},
      {:vllm_disabled_kernels, 0, __MODULE__, ""},
      {:broadcast_tensor_dict, 0, __MODULE__, ""},
      {:vllm_http_timeout_keep_alive, 0, __MODULE__, ""},
      {:get_libc_version, 0, __MODULE__, ""},
      {:vllm_object_storage_shm_buffer_name, 0, __MODULE__, ""},
      {:vllm_mla_disable, 0, __MODULE__, ""},
      {:_date_format, 0, __MODULE__, ""},
      ...
      {:vllm_engine_iteration_timeout_s, 0, __MODULE__, ""},
      {:_forward_context, 0, __MODULE__, ""},
      {:vllm_moriio_num_workers, 0, __MODULE__, ""},
      {:vllm_rocm_use_skinny_gemm, 0, __MODULE__, ""},
      {:init_logger, 1, __MODULE__,
       "The main purpose of this function is to ensure that loggers are"},
      {:is_xnnpack_available, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter_paged_attn, 0, __MODULE__, ""},
      {:init_world_group, 3, __MODULE__, ""},
      {:vllm_enable_inductor_max_autotune, 0, __MODULE__, ""},
      {:_is_otel_imported, 0, __MODULE__, ""},
      {:init_distributed_environment, 0, __MODULE__, ""},
      {:nested_tensors, 0, __MODULE__, ""},
      {:get_env_vars, 0, __MODULE__, ""},
      {:vllm_custom_scopes_for_profiling, 0, __MODULE__, ""},
      {:has_triton, 0, __MODULE__, ""},
      {:vllm_cpu_omp_threads_bind, 0, __MODULE__, ""},
      {:vllm_allreduce_use_symm_mem, 0, __MODULE__, ""},
      {:vllm_moe_dp_chunk_size, 0, __MODULE__, ""},
      {:set_custom_all_reduce, 1, __MODULE__, ""},
      {:_max_temp, 0, __MODULE__, ""},
      {:get_windows_version, 1, __MODULE__, ""},
      {:vllm_compute_nans_in_logits, 0, __MODULE__, ""},
      {:prompt_type, 0, __MODULE__, ""},
      ...
      {:vllm_no_usage_stats, 0, __MODULE__, ""},
      ...
      {:vllm_media_loading_thread_count, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter_triton_rope, 0, __MODULE__, ""},
      {:vllm_use_bytecode_hook, 0, __MODULE__, ""},
      {:init_model_parallel_group, 3, __MODULE__, ""},
      {:check_release_file, 1, __MODULE__, ""},
      {:vllm_enable_fused_moe_activation_chunking, 0, __MODULE__, ""},
      {:__all__, 0, __MODULE__, ""},
      {:vllm_use_mega_aot_artifact, 0, __MODULE__, ""},
      {:vllm_compile_cache_save_format, 0, __MODULE__, ""},
      {:vllm_max_audio_clip_filesize_mb, 0, __MODULE__, ""},
      {:vllm_nccl_include_path, 0, __MODULE__, ""},
      {:get_cudnn_version, 1, __MODULE__,
       "Return a list of libcudnn.so; it's hard to tell which one is being used."},
      {:vllm_dp_size, 0, __MODULE__, ""},
      {:vllm_torch_profiler_with_profile_memory, 0, __MODULE__, ""},
      {:vllm_assets_cache, 0, __MODULE__, ""},
      {:vllm_moe_use_deep_gemm, 0, __MODULE__, ""},
      {:get_cmake_version, 1, __MODULE__, ""},
      {:vllm_tool_json_error_automatic_retry, 0, __MODULE__, ""},
      ...
      {:__all__, 0, __MODULE__, ""},
      {:vllm_nvtx_scopes_for_profiling, 0, __MODULE__, ""},
      {:vllm_has_flashinfer_cubin, 0, __MODULE__, ""},
      {:embeds_inputs, 1, __MODULE__,
       "Construct [`EmbedsInputs`][vllm.inputs.data.EmbedsInputs] from optional"},
      {:vllm_use_nvfp4_ct_emulations, 0, __MODULE__, ""},
      ...
      {:vllm_dp_master_port, 0, __MODULE__, ""},
      {:tensor_model_parallel_all_reduce, 1, __MODULE__,
       "All-reduce the input tensor across model parallel group."},
      {:_reasoning_parsers_to_register, 0, __MODULE__, ""},
      {:get_python_platform, 0, __MODULE__, ""},
      {:vllm_gc_debug, 0, __MODULE__, ""},
      {:global_http_connection, 0, __MODULE__, ""},
      {:get_rocm_version, 1, __MODULE__,
       "Returns the ROCm version if available, otherwise 'N/A'."},
      {:vllm_rocm_use_aiter_mla, 0, __MODULE__, ""},
      {:vllm_allow_insecure_serialization, 0, __MODULE__, ""},
      {:vllm_engine_ready_timeout_s, 0, __MODULE__, ""},
      {:vllm_use_deep_gemm, 0, __MODULE__, ""},
      {:vllm_dbo_comm_sms, 0, __MODULE__, ""},
      {:is_torch_equal_or_newer, 1, __MODULE__,
       "Check if the installed torch version is >= the target version."},
      {:get_tensor_model_parallel_world_size, 0, __MODULE__,
       "Return world size for the tensor model parallel group."},
      {:vllm_mooncake_abort_request_timeout, 0, __MODULE__, ""},
      {:vllm_v1_output_proc_chunk_size, 0, __MODULE__, ""},
      {:sched_yield, 0, __MODULE__, ""},
      {:_print_debug_once, 2, __MODULE__, "Logging configuration for vLLM."},
      {:vllm_use_flashinfer_moe_fp4, 0, __MODULE__, ""},
      {:get_os, 1, __MODULE__, ""},
      {:get_beam_search_score, 3, __MODULE__,
       "Calculate the beam search score with length penalty."},
      {:cached_get_tokenizer, 1, __MODULE__,
       "Gets a tokenizer for the given model name via HuggingFace or ModelScope."},
      {:vllm_cache_root, 0, __MODULE__, ""},
      {:get_current_vllm_config, 0, __MODULE__, ""},
      {:main, 0, __MODULE__, ""},
      {:stream_finished, 0, __MODULE__, ""},
      {:vllm_debug_mfu_metrics, 0, __MODULE__, ""},
      {:vllm_use_fbgemm, 0, __MODULE__, ""},
      {:_prev_minor_version, 0, __MODULE__,
       "For the purpose of testing, return a previous minor version number."},
      {:vllm_rocm_use_aiter_rmsnorm, 0, __MODULE__, ""},
      {:__all__, 0, __MODULE__, ""},
      ...
      {:vllm_assets_cache_model_clean, 0, __MODULE__, ""},
      {:set_current_vllm_config, 1, __MODULE__, "Temporarily set the current vLLM config."},
      {:vllm_xla_cache_path, 0, __MODULE__, ""},
      {:default_plugins_group, 0, __MODULE__, ""},
      {:_tool_parsers_to_register, 0, __MODULE__, ""},
      ...
      {:vllm_target_device, 0, __MODULE__, ""},
      {:vllm_cpu_kvcache_space, 0, __MODULE__, ""},
      {:vllm_ray_bundle_indices, 0, __MODULE__, ""},
      {:init_logger, 1, __MODULE__,
       "The main purpose of this function is to ensure that loggers are"},
      {:suppress_stdout, 0, __MODULE__,
       "Suppress stdout from C libraries at the file descriptor level."},
      {:is_uv_venv, 0, __MODULE__, ""},
      {:vllm_media_url_allow_redirects, 0, __MODULE__, ""},
      {:__all__, 0, __MODULE__, ""},
      {:token_inputs, 1, __MODULE__,
       "Construct [`TokenInputs`][vllm.inputs.data.TokenInputs] from optional"},
      {:vllm_keep_alive_on_engine_death, 0, __MODULE__, ""},
      {:vllm_torch_profiler_use_gzip, 0, __MODULE__, ""},
      {:vllm_rocm_fp8_padding, 0, __MODULE__, ""},
      {:get_tcp_uri, 2, __MODULE__, ""},
      {:generation_tasks, 0, __MODULE__, ""},
      {:logger, 0, __MODULE__, ""},
      {:vllm_disable_compile_cache, 0, __MODULE__, ""},
      ...
      {:vllm_host_ip, 0, __MODULE__, ""},
      {:vllm_loopback_ip, 0, __MODULE__, ""},
      {:cuda_platform_plugin, 0, __MODULE__, ""},
      {:vllm_msgpack_zero_copy_threshold, 0, __MODULE__, ""},
      {:rocm_platform_plugin, 0, __MODULE__, ""},
      {:use_sched_yield, 0, __MODULE__, ""},
      {:vllm_mooncake_bootstrap_port, 0, __MODULE__, ""},
      {:run_and_parse_first_match, 3, __MODULE__,
       "Run command using run_lambda, returns the first regex match if it exists."},
      {:vllm_log_batchsize_interval, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter_fusion_shared_experts, 0, __MODULE__, ""},
      {:batched_tensor_inputs, 0, __MODULE__, "dict() -> new empty dictionary"},
      {:vllm_use_deep_gemm_e8_m0, 0, __MODULE__, ""},
      ...
      {:vllm_max_tokens_per_expert_fp4_moe, 0, __MODULE__, ""},
      {:track_batchsize, 0, __MODULE__, ""},
      ...
      {:vllm_xla_use_spmd, 0, __MODULE__, ""},
      {:_prev_minor_version_was, 1, __MODULE__,
       "Check whether a given version matches the previous minor version."},
      {:vllm_do_not_track, 0, __MODULE__, ""},
      {:environment_variables, 0, __MODULE__, ""},
      {:vllm_enable_v1_multiprocessing, 0, __MODULE__, ""},
      {:no_color, 0, __MODULE__, ""},
      {:resolve_obj_by_qualname, 1, __MODULE__,
       "Resolve an object by its fully-qualified class name."},
      {:vllm_disable_shared_experts_stream, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter_fp4_asm_gemm, 0, __MODULE__, ""},
      {:get_cpu_info, 1, __MODULE__, ""},
      {:tensor_model_parallel_gather, 1, __MODULE__,
       "Gather the input tensor across model parallel group."},
      {:vllm_enable_moe_dp_chunk, 0, __MODULE__, ""},
      ...
      {:vllm_use_precompiled, 0, __MODULE__, ""},
      {:vllm_disable_log_logo, 0, __MODULE__, ""},
      {:get_clang_version, 1, __MODULE__, ""},
      {:vllm_use_aot_compile, 0, __MODULE__, ""},
      {:pooling_task, 0, __MODULE__, ""},
      {:local_rank, 0, __MODULE__, ""},
      {:vllm_logging_level, 0, __MODULE__, ""},
      {:vllm_ray_per_worker_gpus, 0, __MODULE__, ""},
      {:is_torch_equal, 1, __MODULE__,
       "Check if the installed torch version is == the target version."},
      {:vllm_rocm_use_aiter_mha, 0, __MODULE__, ""},
      {:get_layers_from_vllm_config, 2, __MODULE__, "Get layers from the vLLM config."},
      {:vllm_worker_multiproc_method, 0, __MODULE__, ""},
      {:vllm_usage_stats_server, 0, __MODULE__, ""},
      ...
      {:vllm_trace_function, 0, __MODULE__, ""},
      {:current_platform, 0, __MODULE__, ""},
      ...
      {:vllm_deepepll_nvfp4_dispatch, 0, __MODULE__, ""},
      {:vllm_use_flashinfer_moe_mxfp4_bf16, 0, __MODULE__, ""},
      {:decoder_only_inputs, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter_moe, 0, __MODULE__, ""},
      {:vllm_flashinfer_moe_backend, 0, __MODULE__, ""},
      {:vllm_use_flashinfer_moe_fp8, 0, __MODULE__, ""},
      {:patched_fused_scaled_matmul_reduce_scatter_fake, 9, __MODULE__, ""},
      {:vllm_rocm_use_aiter_linear, 0, __MODULE__, ""},
      {:vllm_dp_master_ip, 0, __MODULE__, ""},
      {:get_tokenizer, 1, __MODULE__,
       "Gets a tokenizer for the given model name via HuggingFace or ModelScope."},
      {:vllm_main_cuda_version, 0, __MODULE__, ""},
      {:supports_xccl, 0, __MODULE__, ""},
      {:get_default_config_root, 0, __MODULE__, ""},
      {:vllm_mm_hasher_algorithm, 0, __MODULE__, ""},
      {:__all__, 0, __MODULE__, ""},
      {:vllm_rocm_use_aiter, 0, __MODULE__, ""},
      {:vllm_plugins, 0, __MODULE__, ""},
      {:get_running_cuda_version, 1, __MODULE__, ""},
      {:_format, 0, __MODULE__, ""},
      {:get_gpu_topo, 1, __MODULE__, ""},
      {:vllm_use_triton_awq, 0, __MODULE__, ""},
      {:_scalar_types_id_map, 0, __MODULE__, ""},
      {:last_logging_time, 0, __MODULE__, ""},
      {:vllm_skip_precompiled_version_suffix, 0, __MODULE__, ""},
      {:vllm_ray_dp_pack_strategy, 0, __MODULE__, ""},
      {:vllm_deepep_buffer_size_mb, 0, __MODULE__, ""},
      {:tokenizer_registry, 0, __MODULE__, ""},
      {:_init_trace, 0, __MODULE__, ""},
      ...
      {:vllm_server_dev_mode, 0, __MODULE__, ""},
      {:__setattr__, 2, __MODULE__, ""},
      {:prepare_communication_buffer_for_model, 1, __MODULE__,
       "Prepare the communication buffer for the model."},
      {:vllm_rocm_moe_padding, 0, __MODULE__, ""},
      {:vllm_allow_runtime_lora_updating, 0, __MODULE__, ""},
      {:q_scale_constant, 0, __MODULE__, ""},
      {:builtin_platform_plugins, 0, __MODULE__, ""},
      {:nested_tensors, 0, __MODULE__, ""},
      {:vllm_cpu_sgl_kernel, 0, __MODULE__, ""},
      {:vllm_mq_max_chunk_bytes_mb, 0, __MODULE__, ""},
      {:vllm_marlin_input_dtype, 0, __MODULE__, ""},
      {:multimodal_registry, 0, __MODULE__, ""},
      {:__all__, 0, __MODULE__, ""},
      {:logits_processor, 0, __MODULE__, ""},
      {:try_match_architecture_defaults, 1, __MODULE__, ""},
      {:forward_start_time, 0, __MODULE__, ""},
      {:s3_access_key_id, 0, __MODULE__, ""},
      {:all_gather, 4, __MODULE__, ""},
      {:disable_compile_cache, 0, __MODULE__, ""},
      {:vllm_deepep_low_latency_use_mnnvl, 0, __MODULE__, ""},
      {:env_set_with_choices, 3, __MODULE__,
       "Creates a lambda which that validates environment variable"},
      {:vllm_xgrammar_cache_mb, 0, __MODULE__, ""},
      {:initialize_model_parallel, 0, __MODULE__, "Initialize model parallel groups."},
      {:vllm_shared_experts_stream_token_threshold, 0, __MODULE__, ""},
      {:log_tracing_disabled_warning, 0, __MODULE__, ""},
      {:get_tp_group, 0, __MODULE__, ""},
      {:vllm_rocm_quick_reduce_cast_bf16_to_fp16, 0, __MODULE__, ""},
      {:vllm_rpc_timeout, 0, __MODULE__, ""},
      {:log_scope, 0, __MODULE__, "Logging configuration for vLLM."},
      {:vllm_rocm_quick_reduce_quantization, 0, __MODULE__, ""},
      {:singleton_inputs, 0, __MODULE__, ""},
      {:logger, 0, __MODULE__, ""},
      {:resolve_obj_by_qualname, 1, __MODULE__,
       "Resolve an object by its fully-qualified class name."},
      ...
      {:processor_inputs, 0, __MODULE__, ""},
      {:vllm_use_flashinfer_moe_mxfp4_mxfp8, 0, __MODULE__, ""},
      {:vllm_disable_pynccl, 0, __MODULE__, ""},
      {:vllm_logging_stream, 0, __MODULE__, ""},
      {:vllm_tpu_most_model_len, 0, __MODULE__, ""},
      {:io_processor_plugins_group, 0, __MODULE__, ""},
      {:vllm_use_ray_wrapped_pp_comm, 0, __MODULE__, ""},
      {:divide, 2, __MODULE__,
       "Ensure that numerator is divisible by the denominator and return"},
      {:vllm_torch_profiler_with_flops, 0, __MODULE__, ""},
      {:v_scale_constant, 0, __MODULE__, ""},
      {:vllm_float32_matmul_precision, 0, __MODULE__, ""},
      {:tensor_model_parallel_all_gather, 1, __MODULE__,
       "All-gather the input tensor across model parallel group."},
      {:config, 1, __MODULE__,
       "A decorator that ensures all fields in a dataclass have default values"},
      {:max_jobs, 0, __MODULE__, ""},
      {:vllm_use_flashinfer_moe_mxfp4_mxfp8_cutlass, 0, __MODULE__, ""},
      {:in_the_same_node_as, 1, __MODULE__,
       "This is a collective operation that returns if each rank is in the same node"},
      {:vllm_tpu_bucket_padding_gap, 0, __MODULE__, ""},
      {:pooling_tasks, 0, __MODULE__, ""},
      {:vllm_usage_source, 0, __MODULE__, ""},
      {:_methods_to_patch, 0, __MODULE__, ""},
  ...
  def __classes__ do
    [
      ...
      {Vllm.SamplingParams.SamplingType,
      ...
      {Vllm.SamplingParams.TokenizerLike, "Sampling parameters for text generation."},
