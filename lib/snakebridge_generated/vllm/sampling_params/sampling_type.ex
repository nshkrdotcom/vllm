...
# Python class: SamplingType

defmodule Vllm.SamplingParams.SamplingType do
  @moduledoc """
  Enum where members are also (and must be) ints
  """
  def __snakebridge_python_name__, do: "vllm.sampling_params"
  def __snakebridge_python_class__, do: "SamplingType"
  ...
  def greedy(ref) do
    SnakeBridge.Runtime.get_attr(ref, :GREEDY)
  end

  @spec random(SnakeBridge.Ref.t()) :: {:ok, term()} | {:error, Snakepit.Error.t()}
  def random(ref) do
    SnakeBridge.Runtime.get_attr(ref, :RANDOM)
  end

  @spec random_seed(SnakeBridge.Ref.t()) :: {:ok, term()} | {:error, Snakepit.Error.t()}
  def random_seed(ref) do
    SnakeBridge.Runtime.get_attr(ref, :RANDOM_SEED)
  end
