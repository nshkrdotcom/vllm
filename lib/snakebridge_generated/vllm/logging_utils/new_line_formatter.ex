...
# Python class: NewLineFormatter

defmodule Vllm.LoggingUtils.NewLineFormatter do
  @moduledoc """
  Adds logging prefix to newlines to align multi-line messages.
  """
  def __snakebridge_python_name__, do: "vllm.logging_utils"
  def __snakebridge_python_class__, do: "NewLineFormatter"
  ...
  @doc """
  Python method `NewLineFormatter.formatMessage`.
